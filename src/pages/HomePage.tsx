      ...
      <div id="hero" data-section="hero" data-webild-component="HeroBillboard" data-webild-component-path="@/components/sections/hero/HeroBillboard">
        <SectionErrorBoundary name="hero">
          <HeroBillboard
            ...
            primaryButton={{ text: "Explore Our Approach", href: "#approach" }}
            secondaryButton={{ text: "View Case Studies", href: "#results" }}
      ...
      <div id="expertise" data-section="expertise" data-webild-component="AboutFeaturesSplit" data-webild-component-path="@/components/sections/about/AboutFeaturesSplit">
        <SectionErrorBoundary name="expertise">
          <AboutFeaturesSplit
            ...
            items={[
              { icon: "Star", title: "Narrative Development", description: "Defining your core message to ensure consistency across every channel and stakeholder interaction." },
      ...
      <div id="results" data-section="results" data-webild-component="MetricsMediaCards" data-webild-component-path="@/components/sections/metrics/MetricsMediaCards">
        <SectionErrorBoundary name="results">
          <MetricsMediaCards
            ...
            metrics={[
              { value: "34%", title: "Engagement Increase", description: "Average increase in audience retention for our shortform content deployments.", imageSrc: "http://img.b2bpic.net/free-photo/dynamic-data-visualization-3d_23-2151904321.jpg" },
              { value: "500k+", title: "Voters Reached", description: "Unique voters reached through our integrated messaging platforms.", imageSrc: "http://img.b2bpic.net/free-photo/pinpoint-place-europe_23-2148256052.jpg" },
              { value: "12", title: "Successful Campaigns", description: "Electoral campaigns driven to victory through our messaging strategy.", imageSrc: "http://img.b2bpic.net/free-photo/student-home-taking-notes-while-watching-presentation-closeup_482257-118737.jpg" }
            ]}
            textAnimation="fade"
          />
        </SectionErrorBoundary>
      ...
      <div id="social" data-section="social" data-webild-component="SocialProofMarquee" data-webild-component-path="@/components/sections/social-proof/SocialProofMarquee">
        <SectionErrorBoundary name="social">
          <SocialProofMarquee
            ...
            names={["Democratic Governors League", "Citizens for Policy", "NextGen Advocacy", "Labor Forward Union", "Urban Growth Institute", "Green Policy Network", "Progressive Action Fund"]}
            textAnimation="fade-blur"
          />
        </SectionErrorBoundary>
      </div>
      <div id="testimonials" data-section="testimonials" data-webild-component="TestimonialTrustCard" data-webild-component-path="@/components/sections/testimonial/TestimonialTrustCard">
        <SectionErrorBoundary name="testimonials">
          <TestimonialTrustCard
            ...
            avatars={[
              { name: "Sarah Miller", imageSrc: "http://img.b2bpic.net/free-photo/waist-up-confident-businessman-office_329181-19349.jpg" },
              { name: "Marcus Thorne", imageSrc: "http://img.b2bpic.net/free-photo/portrait-middle-aged-businesswoman_23-2148204386.jpg" },
              { name: "Elena Rodriguez", imageSrc: "http://img.b2bpic.net/free-photo/close-up-portrait-smiling-beautiful-woman-years-old-wearing-corporate-clothing-looking-happy_1258-194086.jpg" },
              { name: "David Chen", imageSrc: "http://img.b2bpic.net/free-photo/new-year-spend-with-friends-celebrating_23-2149196973.jpg" },
              { name: "Amina Al-Sayed", imageSrc: "http://img.b2bpic.net/free-photo/close-up-portrait-bearded-smiling-black-man-wool-suit_613910-16049.jpg" }
            ]}
            textAnimation="fade-blur"
          />
        </SectionErrorBoundary>
      ...
      <div id="faq" data-section="faq" data-webild-component="FaqTwoColumn" data-webild-component-path="@/components/sections/faq/FaqTwoColumn">
        <SectionErrorBoundary name="faq">
          <FaqTwoColumn
            ...
            items={[
              { question: "What is your approach to messaging?", answer: "We use quantitative data paired with qualitative narrative storytelling to find your unique value proposition." },
              { question: "Do you focus on digital or traditional?", answer: "We provide a fully integrated approach, but we specialize in digital-first narratives." },
              { question: "How do we get started?", answer: "Contact us for a preliminary strategic audit of your current messaging landscape." },
              { question: "Are you platform-specific?", answer: "Our narratives are designed to adapt to all major digital platforms for consistency." }
            ]}
            textAnimation="slide-up"
          />
        </SectionErrorBoundary>
      ...
      <div id="contact" data-section="contact" data-webild-component="ContactCta" data-webild-component-path="@/components/sections/contact/ContactCta">
        <SectionErrorBoundary name="contact">
          <ContactCta
            ...
            primaryButton={{ text: "Schedule a Strategy Call", href: "mailto:hello@libertywest.com" }}
            secondaryButton={{ text: "Request Proposal", href: "#contact" }}
            textAnimation="slide-up"
          />
        </SectionErrorBoundary>
      </div>
